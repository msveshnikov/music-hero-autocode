        ...
        <header>
          ...
          <nav>
            <ul>
              ...
              <li><Link to="/editor">Notation Editor</Link></li>
              <li><Link to="/instruments">Instrument Library</Link></li>
              <li><Link to="/chord-progression">Chord Progression</Link></li>
              <li><Link to="/melody-suggestion">Melody Suggestion</Link></li>
